...
function runWorkerSimulations(params) {
  ...
  return {
    serverUtilization: totalServerUtil,
    directionalUtilization: totalDirectionalUtil,
    queueTime: aggregateQueueTime,
    maxCounts: aggregateMaxCounts,
    arrivalRates: aggregateArrivalRates,
    delays: aggregateDelays,
